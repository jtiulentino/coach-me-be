...
var Connection = /** @class */ (function () {
    ...
    function Connection(prefix, info) {
        this.prefix = prefix;
        if (!info)
            info = { product: 'sdk', version: "5.3.0" };
...
var getCardServiceTokenContext = function (context) { return (__assign({}, context, { service: CARDS_SERVICE__NAME })); };
/**
...
export { JwtGenerator, JwtVerifier, Jwt, CachingJwtProvider, CallbackJwtProvider, ConstAccessTokenProvider, GeneratorJwtProvider, CardManager, VirgilCardVerifier, RawSignedModel, ModelSigner, VirgilAgent, FileSystemStorageAdapter as DefaultStorageAdapter, StorageEntryAlreadyExistsError, KeyStorage, KeyEntryStorage, InvalidKeyEntryError, KeyEntryAlreadyExistsError, KeyEntryDoesNotExistError, PrivateKeyStorage };
